...
namespace raytracer.core
{
    ...
    public class SampledSpectrum
    {
        ...
        protected SampledSpectrum(ushort nsamples, float defaultValue = 0)
        {
        ...
        public static SampledSpectrum operator +(SampledSpectrum s1, SampledSpectrum s2)
        {
            ...
            var resultSpectrum = new SampledSpectrum(s1._nsamples);
        ...
        {
            var resultSpectrum = new SampledSpectrum(s._nsamples);
        ...
        {
            var result = new SampledSpectrum(s._nsamples);
            for (var i = 0; i < s._nsamples; ++i)
                MathHelper.Clamp(result._samples[i], low, high);
            return result;
        }
