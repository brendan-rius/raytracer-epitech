...
namespace librt3.core
{
    public class RayDifferential : Ray
    {
        ...
        public RayDifferential(Vector3 direction, Vector3 origin, float start = DefaultStartValue,
            float end = DefaultEndValue, uint depth = 0) : base(direction, origin, start, end, depth)
        {
